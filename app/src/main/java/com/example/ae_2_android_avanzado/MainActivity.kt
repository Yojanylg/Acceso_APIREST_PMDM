...
import com.example.ae_2_android_avanzado.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getSeries(query : String){
        CoroutineScope(Dispatchers.IO).launch {
            ...
            val call: Response<SeriesResponse> = getRetrofit().create(ApiService::class.java).getAllSeries(query)
